...
var chunk_I4DHDILO_exports = {};
__export2(chunk_I4DHDILO_exports, {
...
module.exports = __toCommonJS2(chunk_I4DHDILO_exports);
...
var import_chunk_YGSZ66E5 = require("./chunk-YGSZ66E5.js");
var import_chunk_T2MOZ4FY = require("./chunk-T2MOZ4FY.js");
var import_chunk_EK5GRNJV = require("./chunk-EK5GRNJV.js");
var import_chunk_7KV3NCO6 = require("./chunk-7KV3NCO6.js");
var import_chunk_YRBRUREX = require("./chunk-YRBRUREX.js");
var import_chunk_H3T4L34H = require("./chunk-H3T4L34H.js");
var import_chunk_VB4YSTZG = require("./chunk-VB4YSTZG.js");
...
async function readSchemaFromDirectory(schemaPath2) {
  ...
  const config2 = await (0, import_chunk_EK5GRNJV.getConfig)({
    datamodel: files,
...
async function checkUnsupportedDataProxyMessage(command, args, implicitSchema) {
  ...
  for (const [argName, argValue] of argList) {
    ...
    if (argName.includes("schema")) {
      ...
      const config2 = await (0, import_chunk_EK5GRNJV.getConfig)({ datamodel, ignoreEnvVarErrors: true });
      const url = (0, import_chunk_EK5GRNJV.resolveUrl)((0, import_chunk_EK5GRNJV.getEffectiveUrl)(config2.datasources[0]));
...
async function getGenerators(options) {
  ...
  const config = await (0, import_chunk_EK5GRNJV.getConfig)({
    datamodel: schemas,
  ...
  const dmmf = await (0, import_chunk_7KV3NCO6.getDMMF)({
    datamodel: schemas,
    datamodelPath: schemaPath,
    prismaPath,
    previewFeatures
...
The generator needs to either define the \`defaultOutput\` path in the manifest or you need to define \`output\` in the datamodel.prisma file.`
        ...
        const datamodel = (0, import_chunk_T2MOZ4FY.mergeSchemas)({ schemas });
    ...
    for (const generator of generators) {
      if (generator.manifest && generator.manifest.requiresEngines) {
        ...
        if (engineVersion !== version && generator.options && generator.manifest.requiresEngines.includes(queryEngineType) && generatorBinaryPaths[queryEngineType] && generatorBinaryPaths[queryEngineType]?.[binaryTarget]) {
          const customDmmf = await (0, import_chunk_7KV3NCO6.getDMMF)({
            datamodel: schemas,
            datamodelPath: schemaPath,
...
async function formatSchema({ schemas: schemas2 }, inputFormattingOptions) {
  if (process.env.FORCE_PANIC_PRISMA_SCHEMA) {
    handleFormatPanic(
      () => {
        import_chunk_VB4YSTZG.prismaSchemaWasm.debug_panic();
      },
      { schemas: schemas2 }
    );
  }
  ...
  const { formattedMultipleSchemas, lintDiagnostics } = handleFormatPanic(
    () => {
      ...
      const lintDiagnostics2 = (0, import_chunk_YGSZ66E5.lintSchema)({ schemas: formattedMultipleSchemas2 });
      return { formattedMultipleSchemas: formattedMultipleSchemas2, lintDiagnostics: lintDiagnostics2 };
    },
    { schemas: schemas2 }
  );
  const lintWarnings = (0, import_chunk_YGSZ66E5.getLintWarningsAsText)(lintDiagnostics);
...
function formatWasm(schema, documentFormattingParams) {
  const formattedSchema = import_chunk_VB4YSTZG.prismaSchemaWasm.format(schema, JSON.stringify(documentFormattingParams));
