...
var chunk_3QUQDQZR_exports = {};
__export(chunk_3QUQDQZR_exports, {
...
module.exports = __toCommonJS(chunk_3QUQDQZR_exports);
...
[Context: getConfig]`;
    super((0, import_chunk_NKRRPRQX.addVersionDetailsToErrorMessage)(errorMessageWithContext));
  ...
  const configEither = (0, import_function.pipe)(
    (0, import_chunk_7MD6344A.tryCatch)(
      () => {
        ...
        const data = import_chunk_WXPRX36F.prismaSchemaWasm.get_config(params);
        return data;
      },
      (e) => ({
        type: "wasm-error",
