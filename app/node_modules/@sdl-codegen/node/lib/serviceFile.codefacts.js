...
export const getCodeFactsForJSTSFileAtPath = (file, context) => {
    ...
    return fileFact;
    function addCustomTypeResolvers(variableDeclaration) {
...
const getResolverInformationForDeclaration = (initialiser) => {
    ...
    if (initialiser.isKind(tsMorph.SyntaxKind.ArrowFunction) || initialiser.isKind(tsMorph.SyntaxKind.FunctionExpression)) {
        ...
        if (initialiser.isKind(tsMorph.SyntaxKind.ArrowFunction)) {
            ...
            if (isSingleLiner)
                isObjLiteral = isLiteral(initialiser.getBody());
        }
        return {
...
const isLiteral = (node) => node.isKind(tsMorph.SyntaxKind.ObjectLiteralExpression) ||
...
//# sourceMappingURL=serviceFile.codefacts.js.map