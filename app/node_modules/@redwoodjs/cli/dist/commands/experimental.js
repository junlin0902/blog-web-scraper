...
var import_detectProjectRwVersion = __toESM(require("../middleware/detectProjectRwVersion"));
...
}).demandCommand().middleware(import_detectProjectRwVersion.default).epilogue(
