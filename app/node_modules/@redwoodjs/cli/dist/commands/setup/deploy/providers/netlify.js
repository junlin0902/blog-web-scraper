...
var import_netlify = require("../templates/netlify");
const command = "netlify";
const description = "Setup Netlify deploy";
const files = [
  {
    path: import_path.default.join((0, import_lib.getPaths)().base, "netlify.toml"),
    content: import_netlify.NETLIFY_TOML
  }
];
const notes = [
...
const handler = async ({ force }) => {
  ...
  const tasks = new import_listr2.Listr(
    [
      (0, import_helpers.updateApiURLTask)("/.netlify/functions"),
      (0, import_helpers.addFilesTask)({ files, force }),
