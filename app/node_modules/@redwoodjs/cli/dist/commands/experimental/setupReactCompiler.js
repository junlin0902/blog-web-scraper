...
var setupReactCompiler_exports = {};
__export(setupReactCompiler_exports, {
...
module.exports = __toCommonJS(setupReactCompiler_exports);
...
const builder = (yargs) => {
  yargs.option("force", {
    ...
    type: "boolean"
  }).epilogue((0, import_util.getEpilogue)(command, description, EXPERIMENTAL_TOPIC_ID, true));
};
