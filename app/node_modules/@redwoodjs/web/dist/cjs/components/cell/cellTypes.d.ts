...
import type { ApolloClient, NetworkStatus, OperationVariables, QueryReference, UseBackgroundQueryResult } from '@apollo/client';
...
export type SuspendingSuccessProps = React.PropsWithChildren<Record<string, unknown>> & {
    queryRef: QueryReference<DataObject>;
