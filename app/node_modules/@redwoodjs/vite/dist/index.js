...
function redwoodPluginVite() {
  ...
  const realtimeEnabled = fs.existsSync(apiPackageJsonPath) && fs.readFileSync(apiPackageJsonPath, "utf-8").includes("@redwoodjs/realtime");
