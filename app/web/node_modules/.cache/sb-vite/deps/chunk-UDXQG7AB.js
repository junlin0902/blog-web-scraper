...
var convert3 = (type) => {
  ...
  switch (typeof raw < "u" && (base.raw = raw), name) {
    ...
    case "elementType":
    default: {
      if ((name == null ? void 0 : name.indexOf("|")) > 0) try {
...
var parseJsDoc = (value, options = DEFAULT_OPTIONS) => {
  if (!containsJsDoc(value)) return { includesJsDoc: false, ignore: false };
...
//# sourceMappingURL=chunk-UDXQG7AB.js.map
