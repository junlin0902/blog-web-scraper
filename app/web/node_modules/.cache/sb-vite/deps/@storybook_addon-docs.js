...
import {
  ...
  nameSpaceClassNames,
  withReset
} from "./chunk-SXLT4WWB.js";
import "./chunk-VHRVPOJA.js";
import {
  ActionBar
} from "./chunk-XIWVRAZP.js";
import {
  ThemeProvider,
  convert,
  ensure,
  ...
  themes,
  useTheme
} from "./chunk-M2VJLDII.js";
import "./chunk-44KD5YAQ.js";
import {
  require_core_events
} from "./chunk-G6DENIAA.js";
import {
  index_modern_default
} from "./chunk-ZCVA33L5.js";
import {
  SNIPPET_RENDERED,
  SourceType,
  str
} from "./chunk-UDXQG7AB.js";
import {
  stringify
} from "./chunk-IYMF2C55.js";
import {
  esm_default
} from "./chunk-2NF7DPPC.js";
import {
  require_uniq
} from "./chunk-6KWUFHIZ.js";
import {
...
import {
  ...
  rgba
} from "./chunk-WPBFRFFR.js";
import {
  require_pickBy
} from "./chunk-WKRT7Q54.js";
import "./chunk-7MXVCNJK.js";
import {
  require_mapValues
} from "./chunk-7LVYZAKR.js";
import {
  require_cloneDeep
} from "./chunk-H5XB4HEH.js";
import "./chunk-DQPAIIQO.js";
import "./chunk-RA2VAFB6.js";
import "./chunk-QDMIEAYB.js";
import "./chunk-ZWIJE327.js";
import "./chunk-GHGE4Y2Y.js";
import "./chunk-A66B5TWU.js";
import "./chunk-DEAE6Y7J.js";
import "./chunk-Q5Q7DCLY.js";
import "./chunk-ZBRZD755.js";
import "./chunk-G6CJLFVV.js";
import "./chunk-ARZ4IVAU.js";
import "./chunk-M75KCASI.js";
import "./chunk-D6K2CDQ6.js";
import "./chunk-5T7BZFHH.js";
import "./chunk-EBG2QUWU.js";
import "./chunk-Y6ELX3VJ.js";
import "./chunk-3ZQSYKEP.js";
import "./chunk-4J7Q47F5.js";
import "./chunk-4GG3HQD2.js";
import "./chunk-GRQ3AOEZ.js";
import "./chunk-33A5L2EC.js";
import "./chunk-AJPUF37O.js";
import "./chunk-V5PEIAW3.js";
import "./chunk-E7J3PCVZ.js";
import "./chunk-XHPAYFDH.js";
import "./chunk-RFPLMCZU.js";
import "./chunk-35Q5H5S3.js";
import {
  renderElement,
  unmountElement
} from "./chunk-TNIAQLG3.js";
import {
  require_global
} from "./chunk-RL3SZRQX.js";
import {
  require_client_logger
} from "./chunk-GT6KFZ3W.js";
import {
  require_preview_api
} from "./chunk-HEOLDETT.js";
import "./chunk-IN4XXK5G.js";
import "./chunk-X5AO4J6U.js";
import {
  require_react
} from "./chunk-52LGRYSO.js";
import "./chunk-OSGRMIW2.js";
import "./chunk-G5HYPMBB.js";
import "./chunk-NPBAXQ4S.js";
import {
  __commonJS,
  __toESM,
  require_dist,
...
function build_html_default(options) {
  ...
  function updateToc(headingsArray) {
    ...
    if (currentlyHighlighting && !!tocElement && headings.length > 0) {
      ...
      const li = activeTocLink == null ? void 0 : activeTocLink.parentNode;
      ...
      if ((activeTocLink == null ? void 0 : activeTocLink.nextSibling) && activeTocLink.nextSibling.className.indexOf(options.isCollapsedClass) !== -1) {
...
function init(customOptions) {
  ...
  _scrollListener = throttle((e) => {
    ...
    const isTop = ((_a = e == null ? void 0 : e.target) == null ? void 0 : _a.scrollingElement) && e.target.scrollingElement.scrollTop === 0;
...
var Preview = ({ isLoading, isColumn, columns, children, withSource, withToolbar = false, isExpanded = false, additionalActions, className, layout = "padded", ...props }) => {
  let [expanded, setExpanded] = (0, import_react.useState)(isExpanded), { source, actionItem } = getSource(withSource, expanded, setExpanded), [scale, setScale] = (0, import_react.useState)(1), previewClasses = [className].concat(["sbdocs", "sbdocs-preview", "sb-unstyled"]), defaultActionItems = withSource ? [actionItem] : [], [additionalActionItems, setAdditionalActionItems] = (0, import_react.useState)(additionalActions ? [...additionalActions] : []), actionItems = [...defaultActionItems, ...additionalActionItems], { window: globalWindow4 } = import_global.global, copyToClipboard = (0, import_react.useCallback)(async (text) => {
    let { createCopyToClipboardFunction } = await import("./dist-UFN7XQOQ.js");
...
var BooleanControl = ({ name, value: value2, onChange, onBlur, onFocus }) => {
  ...
  if (value2 === void 0) return import_react.default.createElement(Form.Button, { id: getControlSetterButtonId(name), onClick: onSetFalse }, "Set boolean");
...
var ObjectControl = ({ name, value: value2, onChange }) => {
  ...
  if ((0, import_react.useEffect)(() => {
    forceVisible && htmlElRef.current && htmlElRef.current.select();
  }, [forceVisible]), !hasData) return import_react.default.createElement(Form.Button, { id: getControlSetterButtonId(name), onClick: onForceVisible }, "Set object");
...
var TextControl = ({ name, value: value2, onChange, onFocus, onBlur, maxLength }) => {
  ...
  if (value2 === void 0) return import_react.default.createElement(Form.Button, { id: getControlSetterButtonId(name), onClick: onForceVisible }, "Set string");
...
var LazyColorControl = (0, import_react.lazy)(() => import("./Color-6VNJS4EI-CYTLAWSZ.js"));
...
var ArgControl = ({ row, arg, updateArgs, isHovered }) => {
  ...
  if (!control || control.disable) return isHovered ? import_react.default.createElement(Link2, { href: "https://storybook.js.org/docs/react/essentials/controls", target: "_blank", withArrow: true }, "Setup controls") : import_react.default.createElement(NoControl, null);
...
var getComponent = (props = {}, component) => {
  ...
  if (!of) throw new Error("No component found.");
  return of;
};
...
var StoryTable = (props) => {
  ...
  try {
    ...
    if (!story) return import_react.default.createElement(ArgsTable, { isLoading: true, updateArgs, resetArgs });
    ...
    if (storyHasArgsWithControls || (updateArgs = null, resetArgs = null, tabs = {}), component && (!storyHasArgsWithControls || showComponent) && (tabs = addComponentTabs(tabs, { [mainLabel]: component }, story.parameters, include, exclude)), subcomponents) {
      if (Array.isArray(subcomponents)) throw new Error("Unexpected subcomponents array. Expected an object whose keys are tab labels and whose values are components.");
...
var ArgsTable2 = (props) => {
  ...
  if (storyName) return import_react.default.createElement(StoryTable, { ...props, component: main, subcomponents, sort });
  ...
  if (components22) return import_react.default.createElement(ComponentsTable, { ...props, components: components22, sort, parameters });
...
var useSourceProps = (props, docsContext, sourceContext) => {
  ...
  else if (stories.length === 0) try {
    stories = [docsContext.storyById()];
  } catch {
  }
  if (!storiesFromIds.every(Boolean)) return { error: "Oh no! The source is not available.", state: "none" };
...
var getStoryId2 = (props, context) => {
  ...
  if ("of" in props && of === void 0) throw new Error("Unexpected `of={undefined}`, did you mistype a CSF file reference?");
  if (id) return (0, import_client_logger.deprecate)(esm_default`Referencing stories by \`id\` is deprecated, please use \`of\` instead. 
...
var Canvas = (props) => {
  ...
  if (props.withSource && (0, import_client_logger.deprecate)(esm_default`Setting source state with \`withSource\` is deprecated, please use \`sourceState\` with 'hidden', 'shown' or 'none' instead. 
    ...
    Please refer to the migration guide: https://github.com/storybookjs/storybook/blob/next/MIGRATION.md#canvas-block
    `), children) return (0, import_client_logger.deprecate)(esm_default`Passing children to Canvas is deprecated, please use the \`of\` prop instead to reference a story. 
...
var AnchorMdx = (props) => {
  ...
  if (href) {
    if (href.startsWith("#")) return import_react.default.createElement(AnchorInPage, { hash: href }, children);
    if (target !== "_blank" && !href.startsWith("https://")) return import_react.default.createElement(A, { href, onClick: (event) => {
